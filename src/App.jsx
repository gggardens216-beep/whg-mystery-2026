            ...
            <div className="mb-4 rounded border border-white/20 bg-white/10 p-4 text-left">
              ...
              <ul className="space-y-2 text-xs">
                <li className="flex items-center gap-2">
                  <span>🐟</span> 吉田観賞魚：金魚すくい
                </li>
                <li className="flex items-center gap-2">
                  <span>☕</span> オコジュ：ドリンク引換券
                </li>
                <li className="flex items-center gap-2">
                  <span>🌿</span> GGガーデンズ：特製ノベルティ
                </li>
              </ul>
              <a
                ...
                className="mt-6 block w-full rounded-xl bg-[#06C755] px-6 py-4 text-center text-base font-bold text-white shadow-lg transition-all hover:scale-[1.02] active:scale-[0.98]"
              >
                🎁 クリア報酬をうけとる
              </a>
            </div>
