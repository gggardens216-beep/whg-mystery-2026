...
const ZONE_COORDS = {
  'Zone A: 吉田観賞魚': { top: '28%', left: '38%' }, // 青いエリアの上
  'Zone B: GGガーデンズ': { top: '32%', left: '62%' }, // 緑のエリアの上
  'Zone C: Gardens Marché': { top: '58%', left: '68%' }, // 黄色いエリアの上
  'Zone D: Au coju': { top: '62%', left: '42%' }, // 赤紫のエリアの上
  '最終地点: 水の丘': { top: '45%', left: '50%' }, // 全体の中央付近
}
        ...
        <section className="mx-auto w-full max-w-3xl rounded-3xl border border-slate-600 bg-slate-900/70 p-8 shadow-2xl">
          ...
          <div className="mt-8 overflow-hidden rounded-xl bg-gradient-to-br from-[#8d6e63] to-[#5d4037] p-6 text-[#fdf8e7] shadow-inner">
            ...
            <a
              ...
              className="mt-6 block w-full rounded-xl bg-[#06C755] px-6 py-4 text-center text-lg font-bold text-white shadow-lg transition-all hover:scale-[1.02] active:scale-[0.98]"
            >
              🎁 クリア報酬を受け取る
            </a>
          </div>
